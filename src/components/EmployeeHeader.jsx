...
import { AiOutlineInbox, AiOutlineUsergroupAdd } from "react-icons/ai";
...
const EmployeeHeader = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      subNav: [
        ...
        },
        {
          ...
          icon: <MdOutlineAdminPanelSettings className="h-4 w-4" />,
        },
        {
          label: "Personal Info",
          path: "/personal-info",
          icon: <RiInfoCardLine className="h-4 w-4" />,
        },
        {
          label: "Team Members",
          path: "/saved-jobs",
          icon: <AiOutlineUsergroupAdd className="h-4 w-4" />,
        },
        {
          label: "Purchase History",
          path: "/purchase-history",
          icon: <PiCurrencyCircleDollar className="h-4 w-4" />,
        },
      ],
    },
    // {
    ...
    {
      label: "Power Tools",
      icon: <VscTools className="h-5 w-5" />,
      subNav: [
        {
          label: "Test Organize",
          path: "/text-organize",
